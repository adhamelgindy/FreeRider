...
//		return createValidated();
	...
	private Boolean checkTimeSent() {
		return this.timeSent.getTime() >= 1609459200000l && new Date().getTime() >= this.timeSent.getTime();
	}
...
//		}
//		if (this.serial < 0) {
//			errors.add("Serial doesn't exist");
//		}
//		if (this.uuid < 0) {
//			errors.add("uuid doesn't exist");
//		}
//		if(!checkTimeSent()) {
//			errors.add("Time sent doesn't exist");
//		}
//		if(!checkName()) {
